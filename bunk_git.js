...
function start() {
  ...
  for (i = 2; i < 31; i++) {
    ...
    document.getElementById("pic" + i).src = "assets/brick.png";
  };
  don();
  enadir();
  disAB(); disCD();
...
function btnB() {
  ...
  if (room_map[px] == 5) {
    ...
    document.getElementById("butta").innerHTML = "&#9635";
    document.getElementById("buttb").innerHTML = "&#9635";
    document.getElementById("slot" + item).src = "assets/keys.png";
...
function victory() {
  ...
  document.getElementById("slot" + item).src = assets/donut_xxx + "donut.png"; item++;
  return;
}
